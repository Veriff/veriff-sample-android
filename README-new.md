...
* [Get the verification status](#get-the-verification-status)
    * [In the activity](#get-status-in-the-activity)
    * [Using a background service](#get-status-using-a-background-service)
    * [Using a broadcast receiver](#get-status-using-a-broadcast-receiver)
